#!/usr/bin/env python3
"""
Comprehensive procedure content database with high-quality SEO/GEO optimized content
for all OSHUNJA procedures in Kingston, Jamaica.
"""
...
PROCEDURES = {
    ...
    'botox.html': {
        ...
        'og_title': 'Botox Kingston Jamaica | Natural Anti-Wrinkle Treatment | OSHUNJA',
        'og_description': 'Expert Botox injections in Kingston, Jamaica. Smooth wrinkles and prevent fine lines with FDA-approved treatments.',
    ...
    'juvederm.html': {
        'category': 'facial',
        'title': 'Juvederm Dermal Fillers',
        'meta_title': 'Juvederm Dermal Fillers Kingston Jamaica | Natural Volume Restoration | OSHUNJA',
        'meta_description': 'Expert Juvederm treatments in Kingston, Jamaica. FDA-approved hyaluronic acid fillers for natural volume restoration, wrinkle smoothing, and facial enhancement at OSHUNJA.',
        'og_title': 'Juvederm Dermal Fillers Kingston Jamaica | OSHUNJA',
        'og_description': 'Expert Juvederm treatments in Kingston, Jamaica. FDA-approved hyaluronic acid fillers for natural volume restoration and facial enhancement.',
        'hero_title': 'Juvederm Dermal Fillers',
        'hero_subtitle': 'Restore youthful volume and smooth facial lines with FDA-approved hyaluronic acid fillers in Kingston, Jamaica',
        'duration': '30-60 minutes',
        'anesthesia': 'Topical numbing cream',
        'recovery': 'Minimal (1-3 days)',
        'results': 'Lasts 9-18 months',
        'overview': [
            'Juvederm at OSHUNJA uses FDA-approved hyaluronic acid fillers to restore lost facial volume, smooth static wrinkles, and enhance your natural contours. Our Kingston-based aesthetic physicians combine medical expertise with an artistic eye to deliver results that look refreshed, never overdone.',
            'Kingston\'s tropical climate and vibrant lifestyle demand results that maintain their beauty in every setting. We use advanced injection techniques and premium products specifically chosen for their longevity and natural appearance in warm, humid conditions.',
            'Each Juvederm treatment plan is customized to your unique facial anatomy and aesthetic goals—whether you\'re addressing nasolabial folds, enhancing lips, restoring cheek volume, or refining your jawline. Our team ensures you achieve balanced, beautiful results that enhance your confidence.'
        ],
        'cta_heading': 'Ready for Natural, Beautiful Volume?',
        'cta_text': 'Book a consultation with OSHUNJA\'s aesthetic team in Kingston to discover how Juvederm can restore youthful volume and enhance your natural beauty. We\'ll create a personalized treatment plan designed specifically for your facial structure and goals.'
    },
    ...
    'microneedling.html': {
        ...
        'og_title': 'Microneedling Kingston Jamaica | Collagen Stimulation | OSHUNJA',
        'og_description': 'Advanced microneedling in Kingston, Jamaica. Improve skin texture, reduce scars, and boost collagen production.',
    ...
    'prp-facial.html': {
        ...
        'og_title': 'PRP Facial (Vampire Facial) Kingston Jamaica | OSHUNJA',
        'og_description': 'Natural skin rejuvenation with PRP facial therapy in Kingston, Jamaica using your body\'s healing power.',
    ...
    'laser-hair-removal.html': {
        ...
        'og_title': 'Laser Hair Removal Kingston Jamaica | All Skin Tones | OSHUNJA',
        'og_description': 'Permanent hair removal safe for Caribbean skin in Kingston, Jamaica. Advanced laser technology for all skin tones.',
    ...
    'prp-hair-restoration.html': {
        ...
        'og_title': 'PRP Hair Restoration Kingston Jamaica | Natural Hair Growth | OSHUNJA',
        'og_description': 'Combat hair loss naturally with PRP therapy in Kingston, Jamaica. Stimulate dormant follicles for fuller hair.',
    ...
    'liposuction-360-180.html': {
        ...
        'og_title': 'Liposuction 360/180 Kingston Jamaica | Total Body Sculpting | OSHUNJA',
        'og_description': 'Comprehensive body contouring in Kingston, Jamaica. Remove stubborn fat and sculpt your ideal silhouette.',
    ...
    'prp-breast-lift.html': {
        ...
        'og_title': 'PRP Breast Lift (Vampire Breast Lift) Kingston Jamaica | OSHUNJA',
        'og_description': 'Non-surgical breast enhancement in Kingston, Jamaica using your body\'s natural healing factors.',
    ...
    'renuvion-abdomen.html': {
        ...
        'og_title': 'Renuvion Abdomen Skin Tightening Kingston Jamaica | OSHUNJA',
        'og_description': 'Tighten loose abdominal skin without surgery in Kingston, Jamaica using revolutionary plasma technology.',
    ...
    'renuvion-back.html': {
        ...
        'og_title': 'Renuvion Back Tightening Kingston Jamaica | OSHUNJA',
        'og_description': 'Eliminate back bulges and tighten skin in Kingston, Jamaica with minimally invasive Renuvion technology.',
    ...
    'renuvion-neck.html': {
        ...
        'og_title': 'Renuvion Neck Lift Kingston Jamaica | Non-Surgical | OSHUNJA',
        'og_description': 'Tighten and rejuvenate your neck without surgery in Kingston, Jamaica using advanced plasma technology.',
    ...
    'renuvion-arms.html': {
        ...
        'og_title': 'Renuvion Arms Tightening Kingston Jamaica | OSHUNJA',
        'og_description': 'Tighten arm skin and eliminate bat wings in Kingston, Jamaica without major surgery.',
...
# Note: This is Part 1 - Additional procedures will be added in subsequent parts
# due to file length constraints. The script will be modular to handle all procedures.
